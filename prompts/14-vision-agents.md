...
Reuse STREAM_API_KEY/STREAM_API_SECRET from the parent .env and add OPENAI_API_KEY. By default the teacher explains in English and teaches the selected language through English, introducing target-language words and phrases alongside their English translations rather than only ever speaking English.
